    ...
    <>
      <AppBar style={{backgroundColor: 'rgb(11, 96, 207)'}} position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}>
        <Toolbar className={classes.toolbar}>
          ...
          <img src={logo} style={{maxWidth: '120px'}} alt="ava" />
          <Typography component="h1" variant="h6" style={{padding:'5px 0px 0px 8px'}} color="inherit" noWrap className={classes.title}>
           Admin
          </Typography>
